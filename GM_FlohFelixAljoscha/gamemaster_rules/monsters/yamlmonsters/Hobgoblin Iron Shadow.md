...
actions:
  ...
  - name: "Unarmed Strike"
    desc: "Melee Weapon Attack +5 to hit, reach 5 ft., one target. 5 (1d4 + 3) bludgeoning damage."
  - name: "Dart"
...
legendary_actions:
spells:
  - "The hobgoblin is a 2nd-level spellcaster. Its spellcasting ability is Intelligence (spell save 12, +4 to hit with spell attacks). It has the following wizard spells prepared:"
