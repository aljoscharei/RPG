...
actions:
  ...
  - name: "Bite"
    desc: "Melee Weapon Attack +6 to hit, reach 5 ft., one target. 4 (1d4 + 2) piercing damage."
  - name: "Unarmed Strike"
    desc: "Melee Weapon Attack +6 to hit, reach 5 ft., one target. 5 (1d6 + 2) bludgeoning damage plus 3 (1d6) lightning damage, and the target can't take reactions until the end of the kuo-toa's next turn."
bonus_actions:
reactions:
legendary_actions:
spells:
