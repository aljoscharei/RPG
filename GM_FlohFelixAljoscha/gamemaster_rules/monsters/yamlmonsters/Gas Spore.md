...
traits:
  ...
  - name: "Eerie Resemblance"
    desc: "The gas spore resembles a beholder. A creature that can see the gas spore can discern its true nature with a successful 15 Intelligence (Nature) check."
actions:
  - name: "Touch"
    desc: "Melee Weapon Attack +0 to hit, reach 5 ft., one creature. 1 poison damage, and the creature must succeed on a 10 Constitution saving throw or become infected with the disease described in the Death Burst trait."
bonus_actions:
reactions:
legendary_actions:
spells:
