...
actions:
  ...
  - name: "Electrified Touch"
    desc: "Melee Weapon Attack +8 to hit, reach 5 ft., one target. 27 (6d8) lightning damage."
  - name: "Massive Arm"
    desc: "Melee Weapon Attack +8 to hit, reach 15 ft., one target. 23 (3d12 + 4) bludgeoning damage. If the target is a creature, it must succeed on a 16 Constitution saving throw or is stunned until the end of the yagnoloth's next turn."
  - name: "Life Leech"
...
legendary_actions:
spells:
  - "The yagnoloth's innate spellcasting ability is Charisma (spell save 16). It can innately cast the following spells, requiring no material components:"
