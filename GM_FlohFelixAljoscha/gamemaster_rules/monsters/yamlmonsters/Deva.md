...
actions:
  ...
  - name: "Mace"
    desc: "Melee Weapon Attack +8 to hit, reach 5 ft., one target. 7 (1d6 + 4) bludgeoning damage plus 18 (4d8) radiant damage."
...
legendary_actions:
spells:
  - "The deva's spellcasting ability is Charisma (spell save 17). The deva can innately cast the following spells, requiring only verbal components:"
