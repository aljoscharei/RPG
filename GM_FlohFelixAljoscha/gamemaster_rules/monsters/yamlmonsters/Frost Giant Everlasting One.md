...
traits:
  - name: "Extra Heads"
    desc: "The giant has a {@chance 25|25 percent} chance of having more than one head. If it has more than one, it has advantage on Wisdom (Perception) checks and on saving throws against being blinded, charmed, deafened, frightened, stunned, or knocked unconscious."
  - name: "Regeneration"
...
actions:
  ...
  - name: "Greataxe"
    desc: "Melee Weapon Attack +11 to hit, reach 10 ft., one target. 26 (3d12 + 7) slashing damage, or 30 (3d12 + 11) slashing damage while raging."
  - name: "Rock"
    desc: "Ranged Weapon Attack +11 to hit, range 60/240 ft., one target. 29 (4d10 + 7) bludgeoning damage."
bonus_actions:
reactions:
legendary_actions:
spells:
