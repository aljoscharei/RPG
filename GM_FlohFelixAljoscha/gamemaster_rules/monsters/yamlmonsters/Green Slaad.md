...
actions:
  ...
  - name: "Bite (Slaad Form Only)"
    desc: "Melee Weapon Attack +7 to hit, reach 5 ft., one target. 11 (2d6 + 4) piercing damage."
  - name: "Claw (Slaad Form Only)"
    desc: "Melee Weapon Attack +7 to hit, reach 5 ft., one target. 7 (1d6 + 4) slashing damage."
  - name: "Staff"
    desc: "Melee Weapon Attack +7 to hit, reach 5 ft., one target. 11 (2d6 + 4) bludgeoning damage."
  - name: "Hurl Flame"
    desc: "Ranged Spell Attack +4 to hit, range 60 ft., one target. 10 (3d6) fire damage. The fire ignites flammable objects that aren't being worn or carried."
bonus_actions:
reactions:
legendary_actions:
spells:
  - "The slaad's innate spellcasting ability is Charisma (spell save 12). The slaad can innately cast the following spells, requiring no material components:"
