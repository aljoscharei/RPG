...
actions:
  - name: "Slam"
    desc: "Melee Weapon Attack +8 to hit, reach 10 ft., one target. 7 (1d8 + 3) bludgeoning damage, and the target must succeed on a 19 Constitution saving throw or be poisoned until the end of its next turn."
...
spells:
  - "The larva mage's innate spellcasting ability is Charisma (spell save 16, +8 to hit with spell attacks). It can innately cast the following spells, requiring no material components:"
  - "At will: eldritch blast*, minor illusion"
  - "3/day each: dominate monster"
  - "1/day each: circle of death"
  - spellsNotes: "*3 beams, +3 bonus to each damage roll"
---
```statblock
name: Star Spawn Larva Mage
type: aberration
