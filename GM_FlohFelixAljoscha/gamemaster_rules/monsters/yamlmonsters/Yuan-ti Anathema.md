...
actions:
  ...
  - name: "Claw (Anathema Form Only)"
    desc: "Melee Weapon Attack +10 to hit, reach 10 ft., one target. 13 (2d6 + 6) slashing damage."
  - name: "Constrict"
  ...
  - name: "Flurry of Bites"
    desc: "Melee Weapon Attack +10 to hit, reach 10 ft., one creature. 27 (6d6 + 6) piercing damage plus 14 (4d6) poison damage."
bonus_actions:
reactions:
legendary_actions:
spells:
  - "The anathema's innate spellcasting ability is Charisma (spell save 17). It can innately cast the following spells, requiring no material components:"
