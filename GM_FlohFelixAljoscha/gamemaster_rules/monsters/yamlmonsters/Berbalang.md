...
legendary_actions:
spells:
  - "The berbalang's innate spellcasting ability is Intelligence (spell save 13). The berbalang can innately cast the following spells, requiring no material components:"
