...
actions:
  ...
  - name: "Longsword"
    desc: "Melee Weapon Attack +7 to hit, reach 5 ft., one target. 8 (1d8 + 4) slashing damage, or 9 (1d10 + 4) slashing damage if used with two hands."
  - name: "Longbow"
    desc: "Ranged Weapon Attack +5 to hit, range 150/600 ft., one target. 6 (1d8 + 2) piercing damage."
