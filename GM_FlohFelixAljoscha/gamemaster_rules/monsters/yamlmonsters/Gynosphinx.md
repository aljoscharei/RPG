...
actions:
  ...
  - name: "Claw"
    desc: "Melee Weapon Attack +8 to hit, reach 5 ft., one target. 13 (2d8 + 4) slashing damage."
bonus_actions:
reactions:
legendary_actions:
  - name: "Claw Attack"
...
spells:
  - "The sphinx is a 9th-level spellcaster. Its spellcasting ability is Intelligence (spell save 16, +8 to hit with spell attacks). It requires no material components to cast its spells. The sphinx has the following wizard spells prepared:"
