...
actions:
  - name: "Bite"
    desc: "Melee Weapon Attack +4 to hit, reach 5 ft., one creature. 1 piercing damage, and the target must succeed on a 9 Constitution saving throw or take 2 (1d4) poison damage."
bonus_actions:
reactions:
legendary_actions:
spells:
