...
actions:
  ...
  - name: "Claws"
    desc: "Melee Weapon Attack +5 to hit, reach 5 ft., one target. 5 (1d4 + 3) slashing damage."
  - name: "Trident"
    desc: "Melee / Ranged Weapon Attack +5 to hit, reach 5 ft. or range 20/60 ft., one target. 6 (1d6 + 3) piercing damage, or 7 (1d8 + 3) piercing damage if used with two hands to make a melee attack."
bonus_actions:
reactions:
legendary_actions:
spells:
