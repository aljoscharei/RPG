...
actions:
  - name: "Quarterstaff"
    desc: "Melee Weapon Attack +3 to hit, reach 5 ft., one target. 4 (1d6 + 1) bludgeoning damage, or 5 (1d8 + 1) bludgeoning damage if used with two hands."
bonus_actions:
reactions:
legendary_actions:
spells:
  - "The hobgoblin is a 7th-level spellcaster. Its spellcasting ability is Intelligence (spell save 13, +5 to hit with spell attacks). It has the following wizard spells prepared:"
