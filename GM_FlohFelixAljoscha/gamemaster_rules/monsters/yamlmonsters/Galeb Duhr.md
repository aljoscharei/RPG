...
traits:
  ...
  - name: "Rolling Charge"
    desc: "If the galeb duhr rolls at least 20 feet straight toward a target and then hits it with a slam attack on the same turn, the target takes an extra 7 (2d6) bludgeoning damage. If the target is a creature, it must succeed on a 16 Strength saving throw or be knocked prone."
actions:
  - name: "Slam"
    desc: "Melee Weapon Attack +8 to hit, reach 5 ft., one target. 12 (2d6 + 5) bludgeoning damage."
