...
traits:
  ...
  - name: "Ice Walk"
    desc: "The hag can move across and climb icy surfaces without needing to make an ability check. Additionally, difficult terrain composed of ice or snow doesn't cost her extra moment."
actions:
  - name: "Slam"
    desc: "Melee Weapon Attack +4 to hit, reach 5 ft., one target. 10 (2d8 + 1) bludgeoning damage plus 3 (1d6) cold damage."
...
legendary_actions:
spells:
  - "The hag's innate spellcasting ability is Charisma (spell save 14, +6 to hit with spell attacks). She can innately cast the following spells, requiring no material components:"
  - "At will: hold person*, ray of frost"
  - "3/day each: cone of cold_, ice storm_, wall of ice*"
