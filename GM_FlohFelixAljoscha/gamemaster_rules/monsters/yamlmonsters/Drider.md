...
actions:
  ...
  - name: "Bite"
    desc: "Melee Weapon Attack +6 to hit, reach 5 ft., one creature. 2 (1d4) piercing damage plus 9 (2d8) poison damage."
  - name: "Longsword"
  ...
  - name: "Longbow"
    desc: "Ranged Weapon Attack +6 to hit, range 150/600 ft., one target. 7 (1d8 + 3) piercing damage plus 4 (1d8) poison damage."
bonus_actions:
reactions:
legendary_actions:
spells:
  - "The drider's innate spellcasting ability is Wisdom (spell save 13). The drider can innately cast the following spells, requiring no material components:"
