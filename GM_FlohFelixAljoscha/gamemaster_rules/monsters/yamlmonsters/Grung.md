...
actions:
  - name: "Dagger"
    desc: "Melee / Ranged Weapon Attack +4 to hit, reach 5 ft. or range 20/60 ft., one target. 4 (1d4 + 2) piercing damage, and the target must succeed on a 12 Constitution saving throw or take 5 (2d4) poison damage."
bonus_actions:
reactions:
legendary_actions:
spells:
