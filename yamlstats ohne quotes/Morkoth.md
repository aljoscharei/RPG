...
actions:
  ...
  - name: Bite
    desc: Melee Weapon Attack +6 to hit, reach 5 ft., one target. 9 (2d6 + 2) slashing damage.
  - name: Tentacles
...
legendary_actions:
spells:
  - The morkoth is an 11th-level spellcaster. Its spellcasting ability is Intelligence (save 17, +9 to hit with spell attacks). The morkoth has the following wizard spells prepared:
