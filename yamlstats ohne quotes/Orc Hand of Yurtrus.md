...
actions:
  - name: Touch of the White Hand
    desc: Melee Weapon Attack +3 to hit, reach 5 ft., one target. 9 (2d8) necrotic damage.
bonus_actions:
reactions:
legendary_actions:
spells:
  - The orc is a 4th-level spellcaster. Its spellcasting ability is Wisdom (spell save 12, +4 to hit with spell attacks). It requires no verbal components to cast its spells. The orc has the following cleric spells prepared:
