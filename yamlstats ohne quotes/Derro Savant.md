...
legendary_actions:
spells:
  - The derro savant is a 5th-level spellcaster. Its spellcasting ability is Charisma (spell save 12, +4 to hit with spell attacks). The derro knows the following sorcerer spells:
