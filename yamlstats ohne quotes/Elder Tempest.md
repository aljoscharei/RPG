...
traits:
  ...
  - name: Living Storm
    desc: The tempest is always at the center of a storm 1d6 + 4 miles in diameter. Heavy precipitation in the form of either rain or snow falls there, causing the area to be lightly obscured. Heavy rain also extinguishes open flames and imposes disadvantage on Wisdom (Perception) checks that rely on hearing.  
...
actions:
  ...
  - name: Thunderous Slam
    desc: Melee Weapon Attack +16 to hit, reach 20 ft., one target. 23 (4d6 + 9) thunder damage.
  - name: Lightning Storm (Recharge 6)
    desc: All other creatures within 120 feet of the tempest must each make a 20 Dexterity saving throw, taking 27 (6d8) lightning damage on a failed save, or half as much damage on a successful one. If a target's saving throw fails by 5 or more, the creature is also stunned until the end of its next turn.
bonus_actions:
reactions:
legendary_actions:
  - name: Move
  ...
  - name: Lightning Strike (Costs 2 Actions)
    desc: The tempest can cause a bolt of lightning to strike a point on the ground anywhere under its storm. Each creature within 5 feet of that point must make a 20 Dexterity saving throw, taking 16 (3d10) lightning damage on a failed save, or half as much damage on a successful one.
