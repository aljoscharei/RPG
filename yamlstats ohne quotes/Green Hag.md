...
traits:
  ...
  - name: Mimicry
    desc: The hag can mimic animal sounds and humanoid voices. A creature that hears the sounds can tell they are imitations with a successful 14 Wisdom (Insight) check.
actions:
  - name: Claws
    desc: Melee Weapon Attack +6 to hit, reach 5 ft., one target. 13 (2d8 + 4) slashing damage.
...
legendary_actions:
spells:
  - The hag's innate spellcasting ability is Charisma (spell save 12). She can innately cast the following spells, requiring no material components:
