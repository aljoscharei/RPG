...
legendary_actions:
spells:
  - The warlock's innate spellcasting ability is Charisma. It can innately cast the following spells (spell save 15), requiring no material components:
  -   At will: disguise self, mage armor (self only), silent image, speak with animals
  -   1/day each: conjure fey
  - The warlock is an 11th-level spellcaster. Its spellcasting ability is Charisma (spell save 14, +6 to hit with spell attacks). It regains its expended spell slots when it finishes a short or long rest. It knows the following warlock spells:
