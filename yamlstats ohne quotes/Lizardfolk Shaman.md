...
legendary_actions:
spells:
  - The lizardfolk is a 5th-level spellcaster. Its spellcasting ability is Wisdom (spell save 12, +4 to hit with spell attacks). The lizardfolk has the following druid spells prepared:
