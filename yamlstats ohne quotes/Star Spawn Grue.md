...
actions:
  - name: Confounding Bite
    desc: Melee Weapon Attack +3 to hit, reach 5 ft., one target. 6 (2d4 + 1) piercing damage, and the target must succeed on a 10 Wisdom saving throw or attack rolls against it have advantage until the start of the grue's next turn.
bonus_actions:
reactions:
legendary_actions:
spells:
