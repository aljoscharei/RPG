...
actions:
  - name: Tentacles
    desc: Melee Weapon Attack +4 to hit, reach 5 ft., one target. 1 bludgeoning damage, and the target is grappled (escape 10). Until this grapple ends, the octopus can't use its tentacles on another target.
