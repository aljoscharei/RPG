...
actions:
  ...
  - name: Poisonous Touch (Humanoid Form Only)
    desc: Melee Weapon Attack +8 to hit, reach 5 ft., one target. 28 (8d6) poison damage.
  - name: Bite (Giant Spider Form Only)
    desc: Melee Weapon Attack +7 to hit, reach 5 ft., one target. 12 (2d8 + 3) piercing damage, and the target must make a 15 Constitution saving throw, taking 26 (4d12) poison damage on a failed save, or half as much damage on a successful one. If the poison damage reduces the target to 0 hit points, the target is stable but poisoned for 1 hour, even after regaining hit points, and is paralyzed while poisoned in this way.
  - name: Web (Giant Spider Form Only Recharge 5–6)
    desc: Ranged Weapon Attack +8 to hit, range 30/60 ft., one target. The target is restrained by webbing. As an action, the restrained target can make a 15 Strength check, bursting the webbing on a success. The webbing can also be attacked and destroyed (AC 10; hp 5; vulnerability to fire damage; immunity to bludgeoning, poison, and psychic damage).
bonus_actions:
reactions:
legendary_actions:
spells:
  ...
  - The drow is a 16th-level spellcaster. Its spellcasting ability is Charisma (spell save 16, +8 to hit with spell attacks). It regains its expended spell slots when it finishes a short or long rest. It knows the following warlock spells:
  ...
  -   1/day each: eyebite, etherealness, dominate monster
spellsNotes:
