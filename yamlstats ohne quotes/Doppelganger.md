...
traits:
  ...
  - name: Ambusher
    desc: In the first round of a combat, the doppelganger has advantage on attack rolls against any creature it {@quickref Surprise|PHB|3|0|surprised}.
...
actions:
  ...
  - name: Slam
    desc: Melee Weapon Attack +6 to hit, reach 5 ft., one target. 7 (1d6 + 4) bludgeoning damage.
  - name: Read Thoughts
