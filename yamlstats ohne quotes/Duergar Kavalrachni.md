...
actions:
  ...
  - name: War Pick
    desc: Melee Weapon Attack +4 to hit, reach 5 ft., one target. 6 (1d8 + 2) piercing damage plus 5 (2d4) poison damage.
  - name: Heavy Crossbow
    desc: Ranged Weapon Attack +2 to hit, range 100/400 ft., one target. 5 (1d10) piercing damage.
